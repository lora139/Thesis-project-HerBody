    ...
    <header>
        ...
        <div class="menuToggle" onclick="toggleMenu();"></div><!--тук ли трябва да е div-а-->
            <ul class="navigation"> <!--Полето с навигацията и менютата-->
                ...
                <!-- <li><a href="/newprod.php">Newprod</a></li>Contact полето -->
                    <?php
                        require "global.php";
    ...
    <div class="slider">
        <div class="content">
            ...
            function get_products() {
                ...
                // $pages = ceil($n / 3);
                // for ($i = 0; $i < $pages; ++$i) {
                //     $page_html = "<div class='triple-box'>";
                //     for ($j = 3 * $i; $j < 3; ++$j) {
                //         $page_html += "<div class='box'><div class="
                //     }
                //     $page_html += "</div>";
                // }
                ...
                for ($i = 0; $i < $n; ++$i) {
                    ...
                    if(isset($_COOKIE["login"])){
                        ...
                        if($row[0]==1){
                            echo "<p><button onclick=\"location.href='/product.php?id=".$prod[$i][0]."';\">Learn more</button></p>";
                            echo "<p><button onclick=\"location.href='/newprod.php?token=".$prod[$i][0]."';\">Edit</button></p>";
                            echo "<p><button onclick=\"location.href='/deleteprod.php?token=".$prod[$i][0]."';\">Delete</button></p></div></div>";
                        }else{
                            echo "<p><button onclick=\"location.href='/product.php?id=".$prod[$i][0]."';\">Learn more</button></p></div></div>";
                        }
                    } else {
